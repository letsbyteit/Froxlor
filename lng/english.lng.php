...
$lng['serversettings']['phpfpm_settings']['status_path']['title'] = 'The path to get PHP-FPM status information for monitoring';
$lng['serversettings']['phpfpm_settings']['status_path']['description'] = 'Note: You need should limit access to specific IPs';
